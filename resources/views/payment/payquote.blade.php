...
<body>
    <div class="container">
        <div class="mt-5">
            ...
            <hr class="my-4">
            <p class="lead text-center">Veuillez saisir vos informations, afin de régler l'acompte de {{ number_format((float)$total/100, 2, '.', '') }}€ à Nyleo Conception </p>
          ...
          name: '{{ $customer }}'
            ...
            window.alert(result.error.message);
                ...
                if (result.paymentIntent.status === 'succeeded') {
                    ...
                    window.location.replace('{{ route ('success-paiement', $quote->id) }}');
                }
            }
        });
    });
